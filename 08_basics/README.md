...
--
---
### Мои ответы на Задание 3:

1. **М ∧ П ∧ ¬С** (Мороз И Пасмурно И НЕ Снег)
2. **(Т ∧ Ту) ∨ И** (Температура + И Туман ИЛИ Иней)
3. **(В ∨ С) ∧ М** (Ветер ИЛИ Снег И Мороз)
4. **¬Г ∧ В ∧ М ∧ Н** (НЕ Гололедица И Ветер И Мороз И Налипает снег)
5. **(О ∨ И) ∧ (Т ∨ Я)** (Оттепель ИЛИ Иней И Температура + ИЛИ Ясно)
