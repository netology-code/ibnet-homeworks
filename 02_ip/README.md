...
Для данной схемы сети вывести заполненную таблицу коммутации на коммутаторе Switch0 (команда для вывода таблицы коммутации: `show mac-address-table`).                                   Что касается команды: нажимаете на ваш свитч, в открывшемся окне находите вкладку CLI и там вводите команду `show mac-address-table`
